    ...
    return(
        ...
        <Header style = {{backgroundColor:HeaderColor}}>
          <Left>
            ...
            <Icon name="chevron-left" size={22}  color="#f9fbff" style = {{marginLeft:40/3}} />
            </Button>
          </Left>
          {/* <Body>
            <Title style = {{color:'white',fontWeight:'800',fontSize:22, marginLeft:Platform.OS === 'ios' ? 0 : 30}}>My account</Title>
          </Body> */}
          <Text style = {{ color:White,fontSize:HeaderText,marginLeft:Platform.OS === 'ios'? 0 : 65, fontWeight:HeaderTextFontWeight,marginTop:Platform.OS === 'ios'? 5:10}}>My Account</Text>
          <Right>
        ...
        <Icon name="user" size={25} color="#FFFFFF" style = {styles.iconpadding}/>
           <TextInput style = {styles.textinput} editable ={false} placeholder = "Shivam" placeholderTextColor ="white" ></TextInput>
        </View>

        <View style = {styles.view3}>
        <Icon name="user" size={25} color="#FFFFFF" style = {styles.iconpadding}/>
           <TextInput style = {styles.textinput} editable ={false} placeholder = "Gupta" placeholderTextColor ="white" ></TextInput>
        </View>

        <View style={styles.view3 }>
           <Icon name="envelope" size={20} color="#FFFFFF" style = {styles.iconpadding}/>
           <TextInput style = {styles.textinput} editable ={false}  placeholder = "shivamsgupta@outlook.com" placeholderTextColor ="white" ></TextInput>
           ...
           <TextInput style = {styles.textinput} editable ={false}  placeholder = "8237573477" placeholderTextColor ="white" ></TextInput>
           </View>
